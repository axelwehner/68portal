...
<div class="blog<?php echo $this->params->get('pageclass_sfx') ?> sectionblog">
	...
	<div class="contentdescription<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
		...
		<div class="description_image" style="float: <?php echo $this->section->image_position;?>">
			<img src="<?php echo $this->baseurl ?>/images/stories/<?php echo $this->section->image;?>" alt="<?php echo $this->category->image;?>" />
		</div>
		<?php endif; ?>
